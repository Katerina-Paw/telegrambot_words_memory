...
def autorization():
    f = open('E:/python/Pyth_learn_Katya/Pyth_learn_Katya/db.txt', 'r')
...
def play_game():
    ...
    def hello(message):
        ...
        if (flag):
            ...
            # По очереди готовим текст и обработчик для каждого варианта
    ...
    def answer(call):
        # Если нажали на одну из кнопок — выводим ответ
        if call.data == 'yes':
            a = choice(parser(URL))
            b = 0
            c = 0
